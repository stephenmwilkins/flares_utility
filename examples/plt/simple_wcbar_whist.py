...
x = 'log10Mstar'
y = 'log10sSFR'
z = 'log10SFR' # used for the colour bar

# --- make plot with colour bar plot
fig, ax, cax, hax = plots.simple_wcbar_whist(D, x, y, z, s, limits = limits, labels = labels, cmap = cm.viridis)


fig.savefig(f'figs/simple_wcbar_whist.pdf')
